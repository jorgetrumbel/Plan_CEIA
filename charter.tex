...
Por medio de la presente se acuerda con el Ing. \authorname\hspace{1px} que su Trabajo Final de la \degreename\hspace{1px} se titulará ``\ttitle'', consistirá esencialmente en la implementación de una interfaz y elementos de visión de máquina que permitan programar verificaciones de calidad en procesos industriales, y tendrá un presupuesto preliminar estimado de 600 h de trabajo y U\$D 6000, con fecha de inicio \fechaInicioName\hspace{1px} y fecha de presentación pública \fechaFinalName.
...
Cliente       & Alejandro Virgillo & A3 Engineering	&  Líder de proyecto \\ \hline
...
\begin{itemize}
	...
	\item Orientador: ESCRIBIR ACA ALGO
